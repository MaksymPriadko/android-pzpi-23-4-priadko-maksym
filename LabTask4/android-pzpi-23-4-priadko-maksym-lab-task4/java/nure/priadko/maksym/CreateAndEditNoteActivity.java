...
public class CreateAndEditNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        importanceItems.add(new ImportanceItem(getString(R.string.lowImportance), R.drawable.ic_low_importance));
        importanceItems.add(new ImportanceItem(getString(R.string.mediumImportance), R.drawable.ic_medium_importance));
        importanceItems.add(new ImportanceItem(getString(R.string.highImportance), R.drawable.ic_high_importance));
